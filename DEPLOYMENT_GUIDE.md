...
#### 🔗 Cadena de Conexión
```
postgresql://tu_usuario:tu_password@tu_host.neon.tech/tu_db?sslmode=require&channel_binding=require
```
...
psql "postgresql://tu_usuario:tu_password@tu_host.neon.tech/tu_db?sslmode=require&channel_binding=require"
```
